...
var MenuItem = function (_a) {
    var items = _a.items; _a.isDark; _a.toggleTheme; var currentLang = _a.currentLang, langs = _a.langs, setLang = _a.setLang; _a.cakePriceUsd; _a.buyCakeLabel; var addEcoNet = _a.addEcoNet, addEcoNetLabel = _a.addEcoNetLabel, props = __rest(_a, ["items", "isDark", "toggleTheme", "currentLang", "langs", "setLang", "cakePriceUsd", "buyCakeLabel", "addEcoNet", "addEcoNetLabel"]);
...
var Menu$1 = function (_a) {
    var _b;
    var userMenu = _a.userMenu, globalMenu = _a.globalMenu, isDark = _a.isDark, toggleTheme = _a.toggleTheme, currentLang = _a.currentLang, setLang = _a.setLang, cakePriceUsd = _a.cakePriceUsd, links = _a.links, subLinks = _a.subLinks, footerLinks = _a.footerLinks, activeItem = _a.activeItem, activeSubItem = _a.activeSubItem, langs = _a.langs, buyCakeLabel = _a.buyCakeLabel, addEcoNet = _a.addEcoNet, addEcoNetLabel = _a.addEcoNetLabel, children = _a.children;
    ...
    return (React__default['default'].createElement(Wrapper, null,
        ...
        React__default['default'].createElement(BodyWrapper, { mt: !subLinks ? MENU_HEIGHT + 1 + "px" : "0" },
            React__default['default'].createElement(Inner, { isPushed: false, showMenu: showMenu },
                children,
                React__default['default'].createElement(MenuItem, { items: footerLinks, isDark: isDark, toggleTheme: toggleTheme, langs: langs, setLang: setLang, currentLang: currentLang, cakePriceUsd: cakePriceUsd, buyCakeLabel: buyCakeLabel, addEcoNet: addEcoNet, addEcoNetLabel: addEcoNetLabel, mb: [MOBILE_MENU_HEIGHT + "px", null, "0px"] }))),
