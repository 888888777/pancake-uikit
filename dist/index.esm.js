...
var MenuItems = function (_a) {
    ...
    return (React__default.createElement(Flex, __assign({}, props), items.map(function (_a) {
        ...
        return (React__default.createElement(DropdownMenu, { key: label + "#" + href + "#" + icon, items: menuItems, py: 1, activeItem: activeSubItem },
            React__default.createElement(MenuItem, { href: isTouchDevice() && menuItems && menuItems.length > 0 ? "" : href, isMain: isMain, isActive: isActive, statusColor: statusColor }, label || React__default.createElement(IconComponent, { iconName: icon, color: isActive ? "textCommon" : "textCommon" }))));
    })));
};
