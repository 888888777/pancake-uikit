...
var Menu$1 = function (_a) {
    ...
    return (React__default.createElement(Wrapper, null,
        ...
        React__default.createElement(StyledNav, { showMenu: showMenu, navBackgroundImgUrl: navBackgroundImgUrl },
            ...
            React__default.createElement(Flex, { alignItems: "center" },
                ...
                globalMenu)),
        subLinks && (React__default.createElement(Flex, { justifyContent: "space-around", background: "url('" + bodyBackgroundImgUrl + "') center 136px/cover no-repeat;" },
