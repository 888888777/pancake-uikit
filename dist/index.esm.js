...
var LogoIcon = React__default.memo(Logo$3, function (prev, next) { return prev.isDark === next.isDark; });
...
var FallingBunnies = function (_a) {
    ...
    var bunnies = __spreadArray([], Array(count)).map(function (_, index) { return (React__default.createElement(Bunny, { key: String(index), position: Math.random() * 100, iterations: iterations, duration: duration },
        React__default.createElement(LogoIcon, { width: size, height: size, isDark: false }))); });
...
var StyledBunnyPlaceholder = styled(Icon$20)(templateObject_2$p || (templateObject_2$p = __makeTemplateObject(["\n  height: 100%;\n  width: 100%;\n"], ["\n  height: 100%;\n  width: 100%;\n"])));
...
var Logo = function (_a) {
    ...
    var innerLogo = (React__default.createElement(React__default.Fragment, null,
        React__default.createElement(LogoIcon, { isDark: isDark, className: "mobile-icon" }),
