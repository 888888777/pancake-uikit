...
var Container = styled.div(templateObject_2$j || (templateObject_2$j = __makeTemplateObject(["\n  position: relative;\n"], ["\n  position: relative;\n"])));
...
var MenuItems = function (_a) {
    ...
    return (React__default.createElement(Flex, __assign({}, props), items.map(function (_a) {
        ...
        return (React__default.createElement(DropdownMenu, { key: label + "#" + href + "#" + icon, items: menuItems, py: 1, activeItem: activeSubItem },
            React__default.createElement(MenuItem, { href: isTouchDevice() && menuItems && menuItems.length > 0 ? "" : href, isActive: isActive, statusColor: statusColor }, label || React__default.createElement(IconComponent, { iconName: icon, color: isActive ? "primary" : "primary" }))));
    })));
};
...
var Logo = function (_a) {
    ...
    var innerLogo = (React__default.createElement(React__default.Fragment, null,
        React__default.createElement(Icon$1r, { className: "mobile-icon" }),
